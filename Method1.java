package method;
/*
    숫자를 입력 받아서 더하고 출력하는 단순한 기능을 개발해보자.
...
public class Method1 {
    public static void main(String[] args) {
        ...
        */
        ...
        수학 용어가 나왔다고 전혀 어렵게 생각할 것이 없다! 숫자를 2개 입력하면 해당 숫자를 더한 다음에 그 결과를 출력하는 아주 단순한 함수이다.
        이 함수의 이름은 add 이다.
        ...
        수학의 함수의 개념을 프로그래밍에 가지고 온다면 어떨까? 필요한 기능을 미리 정의해두고 필요할 때 마다
        호출해서 사용할 수 있기 때문에 앞서 고민한 문제들을 해결할 수 있을 것 같다.
