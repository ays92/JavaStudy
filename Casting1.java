...
public class Casting1 {
    public static void main(String[] args) {
        ...
        longValue = intValue; // longValue에 intValue를 대입한다
        System.out.println("longValue = " + longValue);

        doubleValue = intValue; // doubleValue에 intValue를 대입한다
        System.out.println("doubleValue = " + doubleValue);

        doubleValue = 20L; // doubleValue에 20L을 대입한다
        System.out.println("doubleValue = " + doubleValue);
    }
}
/*
        ...
        long double 의 경우에도 double 은 부동 소수점을 사용하기 때문에 더 큰 숫자 범위를 표현한다. 따라서대입할 수 있다.
