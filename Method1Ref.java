...
public class Method1Ref {
    public static void main(String[] args) {
        //계산1
        int sum1 = add(5,10); //add 라는 메서드를 숫자 5,10을 전달하면서 호출한다.
        System.out.println("결과1 출력 : " + sum1); //add(5, 10)이 실행된다. 실행 결과는 반환 값은 15이다.
                                                    //sum1에 15 값이 저장된다.

        //계산2
        int sum2 = add(15,20);  // 파라미터 변수 a=15, b=20이 전달되면서 메서드가 수행된다.
        System.out.println("결과2 출력 : " + sum2);

    }
    //add 메소드
    public static int add(int a, int b) {
        System.out.println(a + " + " + b + " 연산 수행"); // 메서드가 수행된다
        int sum = a+b;
        return sum; // return 을 사용해서 메서드 실행의 결과인 sum 을 반환한다. sum 에는 값 15가 들어있으므로 값 15가 반환된다.
        ...
        */
        ...
        물론 넘기는 값과매개변수(파라미터)의 순서와 갯수도 맞아야 한다.
