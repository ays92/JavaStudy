...
public class MethodValue3 {
    public static void main(String[] args) {
        ...
        num1 = changeNumber(num1);  //호출 시작:changeNumber()
        System.out.println("changeNumber 호출 후, num1 : " + num1); //반환 결과가 10이다.
        //결과: num1(10)
    }

    public static int changeNumber(int num2) {  //num1의 값 5가 num2에 대입된다. num1의 값을 num2에 복사한다. num1(5), num2(5)
